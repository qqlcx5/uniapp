	...
	<view class="content">
		...
		<view class="mobile">
			<view class="mobile-item">
				<image src="../../static/login_2.png"></image>
				账号登录
			</view>
		...
		<view class="login">
			<view class="login-item">
				...
				<input type="text" placeholder-class="placeholder" placeholder="输入手机号">
				<view class="login-btn">
					获取验证码
				</view>
			</view>
			<view class="login-item">
				<image src="../../static/yanzhengma.png" mode=""></image>
				<input type="text" placeholder-class="placeholder" placeholder="输入验证码">
			</view>
