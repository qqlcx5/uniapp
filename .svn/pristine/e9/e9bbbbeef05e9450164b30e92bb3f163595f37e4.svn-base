<template>
	<view class="">
		...
		<view class="dialog">
			...
			<view class="you">
				<view class="you-image" @click="goinfodetail()">
		...
		<view class="bottom">
			<view class="send-message">
				<image class="mgl mgr" src="../../static/biaoqing.png" mode=""></image>
				<input type="text">
				<image class="mgl" src="../../static/fenxiang_2.png" mode=""></image>
				<image class="mgl mgr" src="../../static/jiaohao_2.png" mode=""></image>
			</view>
			<view class="send-box">
